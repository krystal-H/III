...
import { NodeItem, formType, QueueType } from "../../../../../store/types";
import rules from "../../rules";
// import Params from "../comm/Params";
import { ConfigurationProps } from "../../../Configuration";
import { queueTypeList, eventTypeList } from "../../../../../store/constants";

interface MQTTEventProps extends ConfigurationProps {
  nodeItem: NodeItem;
}

class MQTTEvent extends Component<MQTTEventProps> {
